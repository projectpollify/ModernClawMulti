...
export const DEFAULT_FLOOR_MODEL = IS_DIRECT_ENGINE_PROVIDER ? 'google/gemma-4-e4b' : 'gemma4:e4b';
export const LIGHTWEIGHT_FLOOR_MODEL = IS_DIRECT_ENGINE_PROVIDER ? 'google/gemma-4-e2b' : 'gemma4:e2b';
